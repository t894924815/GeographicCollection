...
import org.aki.geographiccollection.client.ui.adapter.MyBusLineAdapter;
 ...
 * AMapV1地图中简单介绍公交线路搜索
 */
public class TestActivity extends Activity implements AMap.OnMarkerClickListener,
        AMap.InfoWindowAdapter, AdapterView.OnItemSelectedListener, BusLineSearch.OnBusLineSearchListener,
        BusStationSearch.OnBusStationSearchListener, View.OnClickListener {
    private AMap aMap;
    ...
    public void searchLine() {
		 ...
		 * query.setPageSize(10); query.setPageNuqmber(currentpage);
        ...
        busLineDialog.onListItemClicklistener(new OnListItemlistener() {
            ...
            public void onListItemClick(BusLineDialog dialog,
                ...
                BusLineSearch busLineSearch = new BusLineSearch(
                        TestActivity.this, busLineQuery);
                busLineSearch.setOnBusLineSearchListener(TestActivity.this);
    ...
    class BusLineDialog extends Dialog implements View.OnClickListener {
        ...
        private MyBusLineAdapter busLineAdapter;
        ...
        /*public BusLineDialog(Context context, List<BusLineItem> busLineItems) {
            ...
            busLineAdapter = new MyBusLineAdapter(context, busLineItems);
        }*/
