...
import org.rxvolley.interf.IDelivery;
import org.rxvolley.interf.IHttpStack;
import org.rxvolley.interf.INetwork;
import org.rxvolley.toolbox.DiskBasedCache;
    ...
    public <T> Request<T> add(Request<T> request) {
        ...
        synchronized (mWaitingRequests) {
            ...
            if (mWaitingRequests.containsKey(cacheKey)) {
                ...
                Log.e("error",String.format("Request for cacheKey=%s is in flight, putting on hold" +
                        ".", cacheKey));
            } else {
        ...
        if (request.shouldCache()) {
            synchronized (mWaitingRequests) {
                ...
                if (waitingRequests != null) {
                    Log.e("error",String.format("Releasing %d waiting requests for cacheKey=%s.",
